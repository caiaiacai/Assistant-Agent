![Assistant-Agent Banner](docs/images/image.png)

# 🚀 Assistant-Agent: 你的进化型“数字孪生”秘书

> **外壳是 Todo 工具，内核是完整的私人秘书系统。** > 基于独创的“九层架构”与“画像蒸馏”技术，实现从**模糊意图**到**自动执行**的闭环。它不只是在执行指令，而是在**进化中学习你的行为偏好**。

[![License MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![Architecture](https://img.shields.io/badge/Arch-9--Layer-orange.svg)](#九层架构详解)
...
| 💡 越用越懂你 | 💰 极低运行成本 | 🛡️ 安全与边界 |
| :--- | :--- | :--- |
| **画像蒸馏 (L9)**：不存臃肿的流水账。每日凌晨自动将行为抽象为高精度用户画像，告别“对话断片”。 | **规则引擎驱动**：九层架构中仅两层（L3/L9）调用 LLM，单条任务成本低至 **$0.001**。 | **权限分级**：提供“保守/均衡/激进”三档权限控制，执行深度完全由你定义，确保隐私安全。 |
